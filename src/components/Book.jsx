    ...
    return (
        <Link to={`/books/${book.id}`} className={`p-3 shadow-lg border ${isDark ? `bg-gray-800` : `bg-white`}`}>
            ...
            <div className="my-3 flex justify-between">
                ...
                <svg onClick={(e) => deleteBookHandlar(e, book.id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 text-red-600">
